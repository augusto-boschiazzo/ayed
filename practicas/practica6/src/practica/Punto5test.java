...
public class Punto5test {
	...
	public static void main(String[] args) {
		...
		lis = m.devolverCaminoMinimo("Buenos Aires","Asuncion");
		System.out.println("--- Se imprime devolverCaminoMinimo ---");
		lis.comenzar();
		while(!lis.fin()) {
			System.out.println(lis.proximo());
		}
		
		lis = m.devolverCaminoSinCargar("Buenos Aires","Asuncion", 6);
		System.out.println("--- Se imprime devolverCaminoSinCargar ---");
		lis.comenzar();
		while(!lis.fin()) {
			System.out.println(lis.proximo());
		}
